    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='asmo.customer', verbose_name='Mijoz')),
            ],
        ),
        migrations.CreateModel(
            name='OrderProduct',
            fields=[
                ...
                ('order', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='asmo.order', verbose_name='Xarid')),
                ('product', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='asmo.product', verbose_name='Maxsulot')),
            ],
        ),
        migrations.CreateModel(
